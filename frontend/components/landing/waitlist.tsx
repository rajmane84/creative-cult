...
export default function Waitlist() {
  ...
  const submit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setSubmitted(true);
    toast.success(`You're #${1284 + Math.floor(Math.random() * 40)} in line.`);
      ...
      >
        ...
        <div className="col-span-12 md:col-span-8">
          ...
          <div className="mt-3 flex flex-wrap gap-3">
            {[
              { k: 'solo', label: 'Solo Freelancer' },
              { k: 'cult', label: 'Cult / Collective' },
              ...
              <button
                ...
                className={`group relative overflow-hidden border border-border px-4 py-2 font-mono text-[11px] uppercase tracking-widest ${
                  role === opt.k ? 'bg-foreground text-background' : ''
                }`}
              >
          ...
          <div className="mt-12">
            ...
            <div className="mt-2 flex items-end gap-4 border-b-2 border-border pb-3">
              <input
                ...
                className="font-editorial placeholder:text-foreground/25 flex-1 bg-transparent text-3xl tracking-tight outline-none md:text-6xl"
              />
              ...
              <motion.button
                ...
                className="group relative overflow-hidden border border-border px-6 py-3 font-mono text-[11px] uppercase tracking-widest md:px-8 md:py-4"
              >
