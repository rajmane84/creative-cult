...
import { CreateCultModal } from './create-cult-modal';
...
export function CultHeader() {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-border pb-6 sm:pb-8">
        ...
        >
          ...
          <p className="font-body text-sm sm:text-base text-muted-foreground max-w-xl">
            Manage the cults you lead or belong to. Collaborate with top
            creatives and win briefs together.
          </p>
        </motion.div>
      ...
      <CreateCultModal open={isModalOpen} onOpenChange={setIsModalOpen} />
    </>
  );
}
